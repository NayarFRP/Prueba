...
class TestMxEdiAdvanceInvoice(AdvanceTransactionCase):
    ...
    def test_005_advance_amounts_fields(self):
        ...
        self.assertEqual(invoice.l10n_mx_edi_amount_advances,
                         invoice.amount_total - invoice.amount_residual, "Advance amount is failing in open state")
        self.assertEqual(invoice.l10n_mx_edi_amount_residual_advances,
                         invoice.amount_residual, "Advance residual amount is failing in open state")
